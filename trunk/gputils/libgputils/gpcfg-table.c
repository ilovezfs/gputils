...
static const struct gp_cfg_option pic16f627a_cp_opts[] =
{ /* for CP: */
	{ "ON",        0x00 },
	{ "OFF",       0x2000 },
};
...
static const struct gp_cfg_option pic16f737_fcmen_opts[] =
{ /* for FCMEN: */
	{ "OFF",       0x00 },
	{ "ON",        0x01 },
};
...
static const struct gp_cfg_option pic16lf1902_fosc_opts[] =
{ /* for FOSC: */
	{ "INTOSC",    0x04 },
	{ "ECL",       0x05 },
	{ "ECM",       0x06 },
...
static const struct gp_cfg_option pic18c242_pwrt_opts[] =
{ /* for PWRT: */
	{ "ON",        0x00 },
	{ "OFF",       0x01 },
};
...
static const struct gp_cfg_option pic18f65j94_fsckm_opts[] =
{ /* for FSCKM: */
	{ "CSECME",    0x00 },
	{ "CSECMD",    0x10 },
	{ "CSDCMD",    0x20 },
...
static const struct gp_cfg_option pic18lf25k50_borv_opts[] =
{ /* for BORV: */
	{ "2V85",      0x00 },
	{ "250",       0x08 },
	{ "220",       0x10 },
...
static const struct gp_cfg_directive pic16f627a_002007[] =
{
	...
	{ "LVP",       0x80,  2, pic12c671_mclre_opts },
	{ "CPD",       0x100,  2, pic12f1822_cpd_opts },
	{ "CP",        0x2000,  2, pic16f627a_cp_opts },
};
...
static const struct gp_cfg_directive pic16f722_002007[] =
{
	...
	{ "BORV",      0x400,  2, pic16f707_borv_opts },
	{ "PLLEN",     0x1000,  2, pic12f1822_ieso_opts },
	{ "DEBUG",     0x2000,  2, pic16f627a_cp_opts },
};
...
{
	{ "FCMEN",     0x01,  2, pic16f737_fcmen_opts },
...
static const struct gp_cfg_directive pic16lf1902_008007[] =
{
	{ "FOSC",      0x03,  4, pic16lf1902_fosc_opts },
	{ "WDTE",      0x18,  4, pic10f320_wdte_opts },
	{ "PWRTE",     0x20,  2, pic10f320_pwrte_opts },
	{ "MCLRE",     0x40,  2, pic10f320_mclre_opts },
	{ "CP",        0x80,  2, pic10f320_cp_opts },
...
{
	{ "PWRT",      0x01,  2, pic18c242_pwrt_opts },
...
{
	{ "CP0",       0x01,  2, pic18c242_pwrt_opts },
...
{
	{ "WRT0",      0x01,  2, pic18c242_pwrt_opts },
...
{
	{ "EBTR0",     0x01,  2, pic18c242_pwrt_opts },
...
{
	{ "STVREN",    0x01,  2, pic16f737_fcmen_opts },
...
{
	{ "PWRTEN",    0x01,  2, pic18c242_pwrt_opts },
...
{
	{ "WDTEN",     0x01,  2, pic16f737_fcmen_opts },
	{ "WDTPS",     0x1e, 16, pic18f1220_wdtps_opts },
};
...
{
	{ "IOL1WAY",   0x01,  2, pic16f737_fcmen_opts },
...
{
	{ "WPDIS",     0x01,  2, pic18c242_pwrt_opts },
};
...
{
	{ "nPWRTEN",   0x01,  2, pic18c242_pwrt_opts },
	{ "BOREN",     0x06,  4, pic18f13k22_boren_opts },
	{ "BORV",      0x18,  4, pic18f23k22_borv_opts },
...
{
	{ "RETEN",     0x01,  2, pic18c242_pwrt_opts },
...
{
	{ "BOREN",     0x01,  2, pic16f737_fcmen_opts },
...
static const struct gp_cfg_directive pic18f65j94_007ff4[] =
{
	...
	{ "FSCKM",     0x30,  3, pic18f65j94_fsckm_opts },
};
...
{
	{ "EBRT0",     0x01,  2, pic18c242_pwrt_opts },
...
{
	{ "EBTR",      0x01,  2, pic18c242_pwrt_opts },
};
...
static const struct gp_cfg_directive pic18lf25k50_300002[] =
{
	{ "nPWRTEN",   0x01,  2, pic18c242_pwrt_opts },
	{ "BOREN",     0x06,  4, pic18f13k22_boren_opts },
	{ "BORV",      0x18,  4, pic18lf25k50_borv_opts },
	{ "nLPBOR",    0x40,  2, pic12f519_cpdf_opts },
};
...
{
	{ 0x000fff, 0xff,  8, pic16f527_000fff },
};
...
static const struct gp_cfg_addr gp_cfg_pic16lf1902_addrs[] =
{
	{ 0x008007, 0xffff,  7, pic16lf1902_008007 },
	{ 0x008008, 0xffff,  5, pic12f1501_008008 },
};
...
static const struct gp_cfg_addr gp_cfg_pic18f24k50_addrs[] =
{
	...
	{ 0x300006, 0xa5,  4, pic18f23k20_300006 },
	{ 0x300008, 0x03,  2, pic18f1220_300008 },
	{ 0x300009, 0xc0,  2, pic18f1220_300009 },
	{ 0x30000a, 0x03,  2, pic18f1220_30000a },
	{ 0x30000b, 0xe0,  3, pic18f1220_30000b },
...
static const struct gp_cfg_addr gp_cfg_pic18f45k50_addrs[] =
{
	...
	{ 0x300003, 0x3f,  2, pic18f23k22_300003 },
	{ 0x300005, 0xd3,  5, pic18f24k50_300005 },
	{ 0x300006, 0xa5,  5, pic18f4455_300006 },
	{ 0x300008, 0x0f,  4, pic18f2320_300008 },
	{ 0x300009, 0xc0,  2, pic18f1220_300009 },
	{ 0x30000a, 0x0f,  4, pic18f2320_30000a },
	{ 0x30000b, 0xe0,  3, pic18f1220_30000b },
...
static const struct gp_cfg_addr gp_cfg_pic18lf13k50_addrs[] =
{
	{ 0x300000, 0x00,  2, pic18f13k50_300000 },
	{ 0x300001, 0x27,  5, pic18f13k22_300001 },
	{ 0x300002, 0x1f,  3, pic18f13k22_300002 },
...
static const struct gp_cfg_addr gp_cfg_pic18lf25k50_addrs[] =
{
	{ 0x300000, 0x00,  4, pic18f24k50_300000 },
	{ 0x300001, 0x25,  4, pic18f24k50_300001 },
	{ 0x300002, 0x5f,  4, pic18lf25k50_300002 },
	{ 0x300003, 0x3f,  2, pic18f23k22_300003 },
	{ 0x300005, 0xd3,  5, pic18f24k50_300005 },
	{ 0x300006, 0xa5,  4, pic18f23k20_300006 },
	{ 0x300008, 0x0f,  4, pic18f2320_300008 },
...
const unsigned gp_cfg_device_count = 613;
const struct gp_cfg_device gp_cfg_devices[] =
{
	...
	{ "PIC16LF1902",   2, gp_cfg_pic16lf1902_addrs },
	{ "PIC16LF1903",   2, gp_cfg_pic16lf1902_addrs },
	{ "PIC16LF1904",   2, gp_cfg_pic16lf1902_addrs },
	{ "PIC16LF1906",   2, gp_cfg_pic16lf1902_addrs },
	{ "PIC16LF1907",   2, gp_cfg_pic16lf1902_addrs },
	...
	{ "PIC18LF13K50", 12, gp_cfg_pic18lf13k50_addrs },
	{ "PIC18LF14K22", 11, gp_cfg_pic18f13k22_addrs },
	{ "PIC18LF14K50", 12, gp_cfg_pic18lf13k50_addrs },
	...
	{ "PIC18LF25K50", 12, gp_cfg_pic18lf25k50_addrs },
	...
	{ "PICMCV08A",     1, gp_cfg_pic12f510_addrs },
	{ "PICMCV14A",     1, gp_cfg_pic16f526_addrs },
	{ "PICMCV18A",     1, gp_cfg_pic16c54_addrs },
	{ "PICMCV18E",     1, gp_cfg_pic16f716_addrs },
	{ "PICMCV20USB",  12, gp_cfg_pic18f13k50_addrs },
	{ "PICMCV28A",     1, gp_cfg_pic16c54_addrs },
