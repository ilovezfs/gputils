...
gp_section_type *gp_coffgen_addsection(gp_object_type *object,
                                         const char *name);
...
gp_symbol_type * gp_coffgen_findsymbol(gp_object_type *object,
                                         const char *name);
gp_symbol_type * gp_coffgen_findsectionsymbol(gp_object_type *object,
                                                const char *name);
gp_aux_type *gp_coffgen_addaux(gp_object_type *object,
