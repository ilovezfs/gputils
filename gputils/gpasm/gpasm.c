...
_set_global_constants(void)
{
  if (!state.mpasm_compatible) {
    set_global("__GPUTILS_SVN_VERSION",   GPUTILS_SVN_VERSION,   LFT_PERMANENT, VAL_CONSTANT, false);
    set_global("__GPUTILS_VERSION_MAJOR", GPUTILS_VERSION_MAJOR, LFT_PERMANENT, VAL_CONSTANT, false);
    set_global("__GPUTILS_VERSION_MINOR", GPUTILS_VERSION_MINOR, LFT_PERMANENT, VAL_CONSTANT, false);
    set_global("__GPUTILS_VERSION_MICRO", GPUTILS_VERSION_MICRO, LFT_PERMANENT, VAL_CONSTANT, false);
    set_global("__WHILE_LOOP_COUNT_MAX",  WHILE_LOOP_COUNT_MAX,  LFT_PERMANENT, VAL_CONSTANT, false);
  }
}
