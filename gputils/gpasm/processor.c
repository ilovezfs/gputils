    ...
    if (found != NULL) {
      ...
      if (state.processor == NULL) {
        ...
        if (!state.mpasm_compatible) {
          ...
          set_global("__GPUTILS_SVN_VERSION",   GPUTILS_SVN_VERSION,   LFT_PERMANENT, GVT_CONSTANT, true);
          set_global("__GPUTILS_VERSION_MAJOR", GPUTILS_VERSION_MAJOR, LFT_PERMANENT, GVT_CONSTANT, true);
          set_global("__GPUTILS_VERSION_MINOR", GPUTILS_VERSION_MINOR, LFT_PERMANENT, GVT_CONSTANT, true);
          set_global("__GPUTILS_VERSION_MICRO", GPUTILS_VERSION_MICRO, LFT_PERMANENT, GVT_CONSTANT, true);
